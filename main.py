...
from unifideck.rpc.mixins.storefront_feed import (  # noqa: E402
    StorefrontFeedRPCMixin,  # NOSTRI in riapplica.sh
)
...
class Plugin(
    ...
    # NOSTRI in riapplica.sh — la home di vetrina, che monte non ha.
    StorefrontFeedRPCMixin,
    UpdaterRPCMixin,
):
